...
const questions: Question[] = [
    // I vs O
    {
        ...
        options: [
            ...
            {text: "어색하지만 먼저 말을 거는 편", score: {O: 3}},
            {text: "주도적으로 분위기를 띄워본다", score: {O: 5}},
        ]
    },
    {
        question: "약속 없이 쉬는 날 아침, 친구가 카톡으로 급 만남 제안!",
        options: [
            {text: "카톡 겉으로 읽고 못 본 척 한다", score: {I: 5}},
    ...
    // },
    {
        ...
        options: [
            {text: "날 아직 못봤다면 빨리 다른 코너로 도망감", score: {I: 5}},
    ...
    // },
    {
        ...
        options: [
            ...
            {text: "여보세요~ 누구세요~? 자연스러운 인싸 모드", score: {O: 5}},
        ]
    },
    {
        question: "많은 사람이 모인 자리, 무대로 나오라고 지목당했을 때 반응은?",
        options: [
            {text: "내 안의 영혼까지 도망감, 절대 안나감", score: {I: 5}},
            {text: "어떻게든 계속 버텨보다가 할 수 없이 나감", score: {I: 3}},
            {text: "그럭저럭 천천히 나가본다", score: {I: 1, O: 1}},
    ...
    // R vs D
    {
        ...
        options: [
            ...
            {text: "고양이야, 혹시 내 과거를 본 거니? 라고 말을 건다", score: {D: 5}},
        ]
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            {text: "지금 납치된 건 아닐까 하는 시나리오 돌림", score: {D: 5}},
        ]
    },
    // {
    ...
    // },
    {
        ...
        options: [
            ...
            {text: "아니 내가 뭐 잘못한게 있었나...?", score: {D: 5}},
        ]
    },
    ...
    // E vs C
    {
        ...
        options: [
            ...
            {text: "‘뭐 어쩌라고’ + ‘내가 민감한가?’ 사이에서 계속 갈등", score: {E: 1, C: 1}},
            {text: "‘이건 굳이 반응할 만한 주제가 아니었음’ 결론 내림", score: {C: 3}},
    ...
    },
    {
        ...
        options: [
            ...
            {text: "실수를 정리해서 다음을 대비함 (회복 빠름)", score: {C: 5}},
        ]
    },
    {
        ...
        options: [
            ...
            {text: "“기프티콘 = 우정 유지 비용 1단계”라고 분석함", score: {C: 5}},
        ]
    },
    // {
    ...
    // },
    {
        ...
        options: [
            {text: "‘헉 무슨 일이지…?’ 벌써 걱정됨", score: {E: 5}},
            {text: "DM 보낼까 말까 10분 고민함", score: {E: 3}},
            {text: "궁금하긴 한데… 뭐 어쩌지", score: {E: 1, C: 1}},
            {text: "관찰만 함. 뇌속에서 원인 추정 시작", score: {C: 3}},
            {text: "“감정적 포스팅은 관심 유도 패턴일 확률 높음” 판단 완료", score: {C: 5}},
        ]
    },
    // {
    ...
    // S vs A
    {
        ...
        options: [
            ...
            {text: "계획 세우는 순간 하기 싫어지는편", score: {A: 5}},
        ]
    },
    // {
    ...
    },
    {
        ...
        options: [
            ...
            {text: "어쩌지? 고민만 계속함", score: {S: 1, A: 1}},
            {text: "다른 데 갈까 하다 그냥 집으로 돌아옴", score: {A: 3}},
            {text: "오늘은 아닌가보다~ 공부 포기", score: {A: 5}},
        ]
    },
    {
        ...
        options: [
            ...
            {text: "간판 찾아보면서 고민함", score: {S: 1, A: 1}},
            {text: "줄 제일 짧은곳으로 감", score: {A: 3}},
            {text: "그냥 지인이 가자는 대로 감", score: {A: 5}},
        ]
    },
    // {
    ...
    // },
    {
        ...
        options: [
            ...
            {text: "신의 손가락이 나를 도와줌, 기적처럼 세잎", score: {A: 5}},
        ]
    },
    // {
